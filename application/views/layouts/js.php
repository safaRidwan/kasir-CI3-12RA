...
<!-- jQuery Knob Chart -->
<script src="<?= base_url('asset/AdminLTE/') ?><?= base_url('asset/AdminLTE/') ?>plugins/jquery-knob/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<script>$('#menghilang').delay('slow').slideDown('slow').delay(4000).slideUp(600);</script>